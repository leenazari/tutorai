...
export async function POST(request: Request) {
  try {
    ...
    const result = await supabaseServer
      .from("sessions")
      .select("id, student_id, scenario_id, scenario_subject, scenario_topic, rating, percentage, total_points, max_points, teacher_summary, student_answer, category_scores, stage_scores, transcript, created_at, students!inner(name, email)")
